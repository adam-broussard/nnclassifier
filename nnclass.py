...
class nn_classifier:
    ...
    def __init__(self, run_folder = './tpzruns/SpecSpec/', data_name = 'tpzrun', acc_cutoff = 0.10, epochs = 1000, nodecounts = [100, 200, 100, 50, 1], splitnum = 5, activations = ['selu', 'selu', 'selu', 'selu', 'sigmoid'], phot_feature_list = ['i', 'gr', 'ri', 'iz', 'zy', 'gri', 'riz', 'izy'], include_tpz_results = True, correct_pz = False):
